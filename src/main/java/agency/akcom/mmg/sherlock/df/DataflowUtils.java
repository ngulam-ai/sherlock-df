...
//				{"userOwoxId","STRING", "NULLABLE","",""}	,
				...
				{"traffic.campaign","STRING", "NULLABLE","","ga:campaign"}	,
				{"traffic.source","STRING", "NULLABLE","","ga:source"}	,
				{"traffic.medium","STRING", "NULLABLE","","ga:medium"}	,
				{"traffic.keyword","STRING", "NULLABLE","","ga:keyword"}	,
				{"traffic.adContent","STRING", "NULLABLE","","ga:adContent"}	,
...
//				{"device.javaEnabled","INTEGER", "NULLABLE", "je","ga:javaEnabled"}	, //TODO need to implement converting to boolean
				{"device.language","STRING", "NULLABLE","","ga:language"}	,
...
//				{"isInteraction","BOOLEAN", "NULLABLE","ni",""}	, //TODO need to implement converting to boolean
...
//				{"page.pageTitle","STRING", "NULLABLE","",""}	,
...
//				{"eventInfo.eventValue","STRING", "NULLABLE","",""}	,
